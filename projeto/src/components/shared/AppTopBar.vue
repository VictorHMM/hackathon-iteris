<template>
  <v-container>
    <v-app-bar app color="#fcb69f" dark short src="../../assets/fita.jpg">
        ...
        <router-link to="/">
          ...
          <router-link to="/general">
            <v-list-item>
              ...
              <v-list-item-title>Bloquinhos</v-list-item-title>
            </v-list-item>
          </router-link>
          ...
          <router-link to="/local">
            <v-list-item>
              ...
              <v-list-item-title>Bloquinhos por cidade</v-list-item-title>
            </v-list-item>
          </router-link>
